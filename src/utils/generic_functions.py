...
def redirect_with_flash(
    url: str = "", location: str = "", message: str = "", error: str = ""
) -> Response:
    if url and location:
        raise ValueError(
            "Both 'url' and 'location' cannot be provided. Provide only one of them."
        )
...
def remove_notification(notification: str, user_id: str) -> None:
    db = current_app.config["DATABASE"]
