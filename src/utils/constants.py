...
SERVER_REGION = os.getenv("SERVER_REGION", "us-central1")
SFKIT_CP0_SERVICE_ACCOUNT = os.getenv("SFKIT_CP0_SERVICE_ACCOUNT")
SFKIT_CP0_NETWORK_NAME = os.getenv("SFKIT_CP0_NETWORK_NAME", "sfkit-cp0")
...
CLOUDFLARE_TURN_KEY_API_TOKEN = os.getenv("CLOUDFLARE_TURN_KEY_API_TOKEN", "")
CLOUDFLARE_TURN_CREDENTIAL_TTL_SEC = int(os.getenv("CLOUDFLARE_TURN_CREDENTIAL_TTL_SEC", "3600"))
...
SENDGRID_FROM_EMAIL = os.getenv("SENDGRID_FROM_EMAIL", "support@sfkit.org")
SENDGRID_FROM_USER = os.getenv("SENDGRID_FROM_USER", "sfkit Support")
